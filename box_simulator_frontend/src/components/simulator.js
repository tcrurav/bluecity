...
const Simulator = () => {
  ...
  useEffect(() => {
	...
	//FALTA EL PARKING OUT, ?NO HAY CONSTANTES DE CARGADOR EN EL PARKING?
	//Cambiar los nombres de los sockets y los posts de renting in
  ...
  const closeBoxParkingIn = () => {
    ...
    socketRef.current.emit('simulator-box-closed-parking-in', { parkingId: SIMULATED_PARKING_ID, boxId: SIMULATED_BOX_ID, chargerState: stateCharger });
  }
